#!/usr/bin/env python3
"""
Evaluation script for the ManyIH coding subset (StyleMBPP).

This script:
1. Formats raw conflicting style MBPP datapoints into LLM messages
...
def format_datapoint_for_llm(
    ...
    Args:
        datapoint: Raw datapoint from style_mbpp.json
...
async def run_evaluation(
    ...
    use_cache: bool = True,
    cache_dir: str = ".cache/style_mbpp",
    ...
    """
    Run full evaluation pipeline on StyleMBPP benchmark asynchronously.

    Args:
        data_file: Path to style_mbpp.json

#!/usr/bin/env python3
"""
Evaluation script for the ManyIH instruction-following subset (AgentIF).
...
def run_prediction(data, model_string, cache_dir=None, api_key=None,
                   max_tokens=10240, num_workers=8):
...
Examples:
  ...
  python -m manyih.instruction_following.evaluator \\
    ...
    parser.add_argument("--max-tokens", type=int, default=10240,
                        help="Max tokens for prediction response (default: 10240)")
